...
const Login = () => {
  ...
  return (
    <div className="relative min-h-screen bg-[#0a0b0f] flex items-center justify-center px-4 py-12 font-sans">
      <div
      ...
      <div className="pointer-events-none absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-indigo-600/10 blur-[100px] rounded-full" />
      ...
      >
        <div className="rounded-xl border border-white/[0.08] bg-[#111318] shadow-[0_1px_0_rgba(255,255,255,0.05)_inset,0_24px_48px_-12px_rgba(0,0,0,0.7)] overflow-hidden">
          <div className="flex items-center justify-between px-4 py-3 border-b border-white/[0.06] bg-[#0d0e13]">
            ...
            <span className="font-mono text-[11px] text-slate-500">alfinakash.dev</span>
          </div>
          ...
          <div className="px-7 py-8 sm:px-9 sm:py-10">
            <div className="flex items-center gap-2.5 mb-7">
              ...
              <span className="font-mono text-[13px] text-slate-400 tracking-tight">azyrexcloud</span>
            </div>

            <h1 className="text-[22px] sm:text-2xl font-semibold text-slate-50 tracking-tight mb-1.5">
              Sign in to continue
            </h1>
            ...
            <motion.button
              ...
              disabled={isLoading}
              className="group w-full flex items-center justify-center gap-2.5 bg-slate-50 hover:bg-white text-slate-900 font-medium text-[14px] rounded-lg py-3 transition-colors disabled:opacity-70 disabled:cursor-wait focus-visible:outline focus-visible:outline-2 focus-visible:outline-indigo-400 focus-visible:outline-offset-2"
            >
              {isLoading ? (
                <>
        ...
        <div className="px-7 sm:px-9 py-4 border-t border-white/[0.06] bg-[#0d0e13] flex items-center justify-between">
  <a
    href="https://github.com/AlfinAkash"
    target="_blank"
    rel="noopener noreferrer"
    className="font-mono text-[11px] text-slate-600 hover:text-indigo-400 transition-colors"
  >
    Built by <span className="text-slate-400">AlfinAkash</span>
  </a>

  <a
    href="https://azyrexcloud.online"
    target="_blank"
    rel="noopener noreferrer"
    className="flex items-center gap-1 font-mono text-[11px] text-slate-600 hover:text-indigo-400 transition-colors"
  >
    Terms
